...
const ROMAJI = ["~a", "a", "~i", "i", "~u", "u", "~e", "e", "~o", "o",
...
function notateKana(line: string, kana: string, regex: string, indexes: number[]): string | null {
...
function romajiToKana(romaji: string): string {
    const re_syllable = /n(?![yaiueoāīūēō])|[wrtypsdfghjkzcvbnm~]*[aiueoāīūēō]|\b \b| ?\u0304/g;
